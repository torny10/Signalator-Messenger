...
* Help new users learn about Signal.
  * Redirect support questions to support@ljsdk.com and the [Signal Support Center](https://support.signal.org/).
